...
PATH_TO_CKPT = MODEL_PATH + rospy.get_param('model', '/frozen_inference_graph_face.pb')
######### Set the label map file here ###########
LABEL_NAME = rospy.get_param('label', 'face_label_map.pbtxt')
...
class Detector:
    ...
    def __init__(self):
        ...
        self.run_detection = rospy.Subscriber("run_detection", Bool, self.run_detect)
        self.is_detection = Bool()


    def run_detect(self, start):

        self.is_detection = start
        # print (self.is_detection)


    def image_cb(self, data):
        global sess
        print (self.is_detection.data)
        if self.is_detection.data ==  True:
